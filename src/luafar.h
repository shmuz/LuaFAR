...
DLLFUNC int     LF_GetVirtualFindData (lua_State* L, struct GetVirtualFindDataInfo *Info);
...
DLLFUNC int     LF_ProcessEvent (lua_State* L, HANDLE hPanel, int Event, void *Param);
DLLFUNC int     LF_ProcessHostFile (lua_State* L, const struct ProcessHostFileInfo *Info);
DLLFUNC int     LF_ProcessPanelInput (lua_State* L, HANDLE hPanel, const struct ProcessPanelInputInfo *Info);
