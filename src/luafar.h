...
DLLFUNC lua_State* LF_LuaOpen(struct PluginStartupInfo *Info, lua_CFunction aOpenLibs, const wchar_t* aEnvPrefix);
DLLFUNC void LF_InitLuaState(lua_State *L, struct PluginStartupInfo *Info, lua_CFunction aOpenLibs, const wchar_t* aEnvPrefix);
